...
import fi.nano.pathfinding.structure.TextMover;
...
public class Pathfinding {
    ...
    Pathfinding(String[] args) throws InterruptedException {
        ...
        MazeEntity chased = new MazeEntity(74, 49);
        ...
        int chasedMoveTimer = moveDelay;

        TextMover mover = new TextMover(chased, mazeReader.GetTargetMovement());
